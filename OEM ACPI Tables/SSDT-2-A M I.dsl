 ...
 *
 * Disassembly of SSDT-2-A M I.aml, Fri Feb  5 13:17:33 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000255F (9567)
 *     Revision         0x02
 *     Checksum         0x92
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
...
DefinitionBlock ("", "SSDT", 2, "ALASKA", "A M I", 0x00001000)
{
    ...
    External (_SB_.PCI0.PEGS, MethodObj)    // 0 Arguments (from opcode)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        {
            Store (Zero, Local0)
            If (LOr (LEqual (And (CPEX, 0x0FFF0FF0), 0x000506E0), LEqual (And (CPEX, 0x0FFF0FF0), 0x000906E0)))
            {
